...
> [!NOTE]
> Записки от упражнения може да намерите в съответната папка за седмицата. Записките са събрани и редактирани от <a href="https://github.com/ymatevva">Йоана Матева</a>.
