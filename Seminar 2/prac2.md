...
6. Напишете програма, която симулира как работи един светофар. Светофарът има три основни състояния – червено, жълто и зелено, и програмата трябва да реагира според тези състояния, като отпечатва подходящо съобщение за действие на потребителя. Тъй като след жълтото веднага следва червено, помислете как може да реализирате това чрез switch case.
