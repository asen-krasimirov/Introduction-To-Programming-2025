...
5. Напишете програма, която взима две числа от стандартния вход и извежда *1* ако първото е по - малко от второто и *0* в противен случай.
...
10. Напишете програма, която разменя стойностите на две числови променливи с допълнителна променлива и без допълнителна променлива.                     
...
14. Напишете програма, която при попададено число n, принтира сумата на числата от 1 до n.
